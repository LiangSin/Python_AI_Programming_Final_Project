...
class Main(QMainWindow, Ui_MainWindow):
  ...
  def openDir(self):
    ...
    pname = QFileDialog.getExistingDirectory(self, "Open Directory", options=QFileDialog.ShowDirsOnly)
    if pname:
  ...
  def changeSaveDir(self):
    ...
    pname = QFileDialog.getExistingDirectory(self, "Open save Directory", options= QFileDialog.ShowDirsOnly)
    if pname:
      # self.savePath = pname
